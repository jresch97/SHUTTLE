...
int main(void)
{
        ...
        widget1 = cos_new(GUI_WIDGET, cos_new(GUI_VBOX, 0, 0, 0, 0, 0));
        ...
        */
        ...
        gui_widget_add_many(root, 1, cos_ref(widget1)); /*, widget2);*/
        gui_widget_add_many(widget1, 2, cos_ref(button1), cos_ref(button2));
        ...
        cos_deref_many(2, root, widget1); /*widget2);*/
